const perguntas = [
  ...
  /*executa repetidamente cada elemento de perguntas e chama eles com o item*/
  for (const item of perguntas) {
    ...
    for (let resposta of item.respostas) {
      ...
      /* ele procura dentro de dL o dT e clona todos os seus filhos se for true e false só o proprio nó */
      const dt = quizItem.querySelector('dl dt').cloneNode(true)

      /*muda o texto dentro do span para a resposta q tem dentro do item*/
      dt.querySelector('span').textContent = resposta

      /*atribue o input com cada index dos itens de perguntas*/
      dt.querySelector('input').setAttribute('name', 'pergunta-' + perguntas.indexOf(item))

    
      /*atribue o value do input com o index de cada resposta*/
      dt.querySelector('input').value = item.respostas.indexOf(resposta)

      /*quando tiver mudança no input ele passa o evento e executa a função*/
      dt.querySelector('input').onchange = (event) => {

        /*compara o value do input com o item correta*/
